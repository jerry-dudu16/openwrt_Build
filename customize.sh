...
sed -i 's/$1$V4UetPzk$CYXluq4wUazHjmCDBCqXF.//g' openwrt/feeds/smpackage/.github/diy/default-settings || true
sed -i 's/$1$V4UetPzk$CYXluq4wUazHjmCDBCqXF.//g' openwrt/package/lean/default-settings/files/zzz-default-settings || true
sed -i '/kenzo/d' openwrt/feeds/smpackage/.github/diy/default-settings || true
